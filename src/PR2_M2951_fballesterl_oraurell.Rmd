...
Encara que aparentment extreure conclusions hagi sigut més complicat de l'esperat, podem determinar sèrie de resultats extrets de l'anàlisi elaborat.
...
Tot i així la resta de variables han permès en major mesura poder extreure les següents conclusions:
 
 - La gran majoria d'oferta d'allotjaments turístics es troben en les ciutats més turístiques.
